...
public class ImuState {
    ...
    public RealVector orientation = Vec4d.create(0,0,0,1);
    ...
    public Mat rImuCam0 = Matx33d.eye(); // TODO: what value? Python is clear, but C++ looks diff?
    public MatOfDouble tCam0Imu = Vec3d.create();
